...
//        Record.Record r1 = new Record.RecordForAction("1", new Date(), Operation.BankingOperation.BankingOperationType.incoming_cash,0.0, "1234");
//        Record.Record r2 = new Record.RecordForTransfer("2", new Date(), Operation.BankingOperation.BankingOperationType.transfer,0.0,200,"125","1234");
//        Record.Record r3 = new Record.RecordForTransfer("3", new Date(), Operation.BankingOperation.BankingOperationType.transfer, 0.0,400,"545","4856");
//
//        History.History.getInstance().addRecord(r1);
//        History.History.getInstance().addRecord(r2);
//        History.History.getInstance().addRecord(r3);
//
//        Predicate<Record.Record> predicate = (p) -> p.getType().equals(Operation.BankingOperation.BankingOperationType.transfer);
//        final List<Record.Record> filterRecordList = History.History.getInstance().filter(predicate);
//
